/*
  Extended Impedance / Compliance Test with Asymmetric Friction Compensation
  -------------------------------------------------------------------------
...
struct Parameters {
  ...
  std::string csv_file_name = "extended_impedance_asymmetric_friction_log.csv";
...
int main() {
  try {
    ...
    std::cout << "Starting 6-axis impedance controller with asymmetric friction compensation." << std::endl;
