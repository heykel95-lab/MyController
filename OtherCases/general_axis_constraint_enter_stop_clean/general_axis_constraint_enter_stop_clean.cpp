...
int main() {
  try {
    ...
    std::cout << "Type e and press Enter during the run to stop the control loop safely." << std::endl;
    if (params.experiment_duration <= 0.0) {
    ...
    std::cout << "Starting general axis-constraint impedance controller WITHOUT friction compensation, with Coriolis switch and e+Enter stop." << std::endl;
